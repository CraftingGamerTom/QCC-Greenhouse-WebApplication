...
public class ManageFriendlyNamesBuilder extends PageBuilder {
	 ...
	 * 
	 * @param type
	 *            as selected by the admin to display certain types
	 * @param model
	 *            the model for the page to be modelled by
	...
	/**
	 * based on a given boolean value the function will return a string to generate
	 * the needed html to display either a checked or unchecked checkbox The String
	 * is put into the html string below
	 * 
	...
	private String getSensorOptions() {
		...
		for (int i = 0; i < allSensors.size(); i++) {
			...
			message += "                                <form role=\"form\" class=\"form-inline\" action=\"/admin/manage/sensors/friendly-names/update\">\r\n"
					+ "                                <tr>\r\n" + "                                    <td>" + index
					+ "</td>\r\n"
					+ "                                    <td><input name=\"sensor-id\" id=\"sensor-id\" type=\"hidden\" class=\"form-control\" value=\""
					+ sensorID + "\">" + sensorID + "</td>\r\n" + "                                    <td>" + type
					+ "</td>\r\n" + "                                    <td>" + date + "</td>\r\n"
					+ "                                    <td><input name=\"description\" id=\"description\" type=\"text\" class=\"form-control\" value=\""
					+ description + "\"></td>\r\n"
